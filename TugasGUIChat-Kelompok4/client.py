...
class GUI:
    ...
    def __init__(self, ip_address, port):
        ...
        self.pls = tk.Label(self.login, 
                            text="Welcome to Keerjain Aja!\nPlease login first to a chatroom", 
                            justify=tk.CENTER,
        ...
        self.roomLabelName = tk.Label(self.login, text="Room Id: ", font="Helvetica 11")
        self.roomLabelName.place(relheight=0.2, relx=0.1, rely=0.40)

        self.roomEntryName = tk.Entry(self.login, font="Helvetica 12", show="*")
    ...
    def layout(self):
        ...
        self.Window.title("Keerjain Aja!")
